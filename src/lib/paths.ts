...
const dirName = 'agent-wallet'

/**
 * Base config directory (AGENT_WALLET_HOME or ~/.agent-wallet)
 */
export function getConfigDir(): string {
  const base = process.env.AGENT_WALLET_HOME || path.join(os.homedir(), '.agent-wallet')
